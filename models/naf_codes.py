# NAF 2008 rev. 1 — nomenclature des activités françaises (INSEE)
# Source : https://www.insee.fr/fr/information/2120875
# Clés : code sans point (ex: "6202A"), valeurs : libellé officiel
...
NAF_LABELS = {
    ...
    "0124Z": "Culture de fruits à pépins et à noyaux",
    "0125Z": "Culture d'autres fruits d'arbres ou d'arbustes et de baies",
    "0126Z": "Culture de fruits oléagineux",
    "0127Z": "Culture de plantes pour la préparation de boissons",
    "0128Z": "Culture de plantes à épices, aromatiques, médicinales et pharmaceutiques",
    "0129Z": "Autres cultures permanentes",
    "0130Z": "Culture et production de matériel de propagation végétale",
    ...
    "0230Z": "Récolte de produits forestiers non ligneux en forêts naturelles",
    ...
    "1431Z": "Fabrication de bas et chaussettes en maille",
    "1439Z": "Fabrication d'autres articles en maille",
    ...
    "1610A": "Sciage et rabotage du bois, sauf imprégnation",
    ...
    "2120Z": "Fabrication de médicaments et d'autres produits pharmaceutiques",
    ...
    "2332Z": "Fabrication de briques, tuiles et produits de construction en terres cuites",
    ...
    "2740Z": "Fabrication de lampes et d'appareils d'éclairage",
    ...
    "2893Z": "Fabrication de machines pour l'industrie agroalimentaire",
    ...
    "4612A": "Centrales d'achat de matières premières agricoles",
    ...
    "4648Z": "Commerce de gros d'articles horlogers et bijouterie",
    ...
    "4920Z": "Transport de fret ferroviaire",
    ...
    "5829A": "Édition de logiciels systèmes et de réseau",
    ...
    "8219A": "Photocopie",
    "8219B": "Autres activités de soutien aux entreprises n.c.a.",
    ...
    "8622C": "Autres activités spécialisées de médecine",
...
def _normalize(code):
    """Strip spaces, uppercase, remove dots: '63.11Z' → '6311Z'."""
    return code.strip().upper().replace(".", "") if code else ""


def format_naf(code):
    """Return the formatted NAF code (with dot, no label).

    '6202A' or '62.02A' → '62.02A'
    """
    raw = _normalize(code)
    if not raw:
        return ""
    return (raw[:2] + "." + raw[2:]) if len(raw) >= 3 else raw


def get_naf_label(code):
    """Return the French label for a NAF code, or empty string if unknown."""
    return NAF_LABELS.get(_normalize(code), "")
